...
Em condições normais, cada personagem possui em seu turno:

> **Movimento + 1 Ação**

O personagem pode **Andar até Curto** e realizar uma Ação. O deslocamento pode ocorrer antes ou depois da Ação e pode ser dividido narrativamente quando isso fizer sentido, sem necessidade de medir metros ou quadrados.

Pequenas interações que não constituem uma ação relevante — como falar brevemente, largar um objeto ou observar algo evidente — fazem parte da narrativa e normalmente não consomem a Ação.
